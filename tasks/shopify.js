...
module.exports = function(grunt) {
    ...
    shopify.getThemeId = function() {
        ...
        var ThemeId = config.options.theme || config.options.ThemeId;
    ...
    shopify.remove = function(file, done) {
        ...
        if ( shopify.getThemeId() != '' && shopify.getThemeId() != undefined ) {
            var options = {
    ...
    shopify.download = function(done) {
        if ( shopify.getThemeId() != '' && shopify.getThemeId() != undefined ) {
            shopify.notify('Using theme specified by options');
            var options = {
                host: shopify.getHost(),
                auth: shopify.getAuth(),
                path: '/admin/themes/' + shopify.getThemeId() + '/assets.json',
            ...
            shopify.notify('Using published theme');
            shopify.notify( shopify.getHost() );
            shopify.notify( shopify.getAuth() );
            var options = {
                hostname: shopify.getHost(),
                auth: shopify.getAuth(),
                path: '/admin/assets.json',
